Buld: includes steps such as preparing environment variables, installing node, installing dependencies, linting the front end, and building the frontend and backend (api)
